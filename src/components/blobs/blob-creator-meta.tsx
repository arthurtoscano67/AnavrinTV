...
export function BlobCreatorMeta({
  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-white/14 bg-[rgba(7,18,36,0.68)] p-3 backdrop-blur-xl">
      <div className="flex items-center gap-3">
        <CreatorLink
          className="grid size-11 shrink-0 place-items-center rounded-full border border-white/14 bg-white/10 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:border-cyan-200/40 hover:bg-white/15"
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-3">
            ...
            {showFollowButton ? (
              isCreatorOwner ? (
                <button
                  className="inline-flex items-center gap-2 rounded-full border border-white/14 bg-[#11213d]/88 px-4 py-2 text-xs font-semibold text-white transition hover:border-cyan-200/35 hover:bg-[#172c4f] active:scale-[0.98]"
                ...
                <button
                  className="inline-flex items-center gap-2 rounded-full border border-white/14 bg-[#11213d]/88 px-4 py-2 text-xs font-semibold text-white transition hover:border-cyan-200/35 hover:bg-[#172c4f] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-45"
              ...
              <div className="rounded-full border border-white/14 bg-[#11213d]/88 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-100">
      ...
      {blob.tags.length ? (
        <div className="mt-2 flex flex-wrap gap-2">
          {blob.tags.slice(0, 4).map((tag) => (
            <button
              key={tag}
              className="rounded-full border border-white/14 bg-[#101f38]/85 px-2.5 py-1 text-[11px] text-slate-100 transition hover:border-cyan-300/35 hover:bg-cyan-300/18"
